...
public class TestModificationNom {
	...
	private static String oldLastname;
	private static String iniLastname;
	...
	public void test1ModifierMHM() throws Exception {
		...
		logger.info("Modifier le nom de l'assuré principal "+newLastname);
		String returnMessage = driverMhm.setLastname(newLastname);
		oldLastname = driverMhm.getOldValue();
		assertTrue(returnMessage.contains("Suivi de mes demandes"));
		assertEquals(oldLastname, iniLastname);
